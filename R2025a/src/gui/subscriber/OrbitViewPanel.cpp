...
void OrbitViewPanel::LoadData()
{
   ...
   try
   {
      ...
      {
         Rvector3 vec = mOrbitView->GetViewVector("ViewPointReference");
      ...
      {
         Rvector3 vec = mOrbitView->GetViewVector("ViewPointVector");
      ...
      {
         Rvector3 vec = mOrbitView->GetViewVector("ViewDirection");
