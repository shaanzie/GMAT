...
public:
   ...
   void UpdateImager(bool updateObjectArray = true);
...
private:
   ...
   std::vector<wxCheckListBox*> mImagerCLBList;
   ...
   std::vector<wxArrayString*> mImagerExcList;
