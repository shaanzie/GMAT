...
protected:
   ...
   bool                 isFinalized;
   /// flag indicating whether to reinitialize the current function
   bool                 reinitializeFunc;
   /// flag indicating whether this FM is the original owner of a functions
   bool                 isObjStoreOwner;
