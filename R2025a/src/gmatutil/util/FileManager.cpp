...
void FileManager::WriteStartupFile(const std::string &fileName)
{
   ...
   //---------------------------------------------
   // write the help file paths next
   //---------------------------------------------
   #ifdef DEBUG_WRITE_STARTUP_FILE
   MessageInterface::ShowMessage("   .....Writing HELP_DIRECTORY_FILE and "
      "HELP_HTML_FILE\n");
   #endif
   ...
   outStream << "#-----------------------------------------------------------\n";
   mFileWrittenOuts.push_back("HELP_HTML_FILE");
...
void FileManager::RefreshFiles()
{
   ...
   // help file
   AddFileType("HELP_PATH", "ROOT_PATH/docs/help")
   AddFileType("HELP_DIRECTORY_FILE", "HELP_PATH/help.chm");
   AddFileType("HELP_HTML_FILE", "HELP_PATH/help.html")
