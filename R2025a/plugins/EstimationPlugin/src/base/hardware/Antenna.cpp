...
const std::string
Antenna::PARAMETER_TEXT[AntennaParamCount - ImagerParamCount] =
   {
      "Delay",
...
Antenna::PARAMETER_TYPE[AntennaParamCount - ImagerParamCount] =
   {
      Gmat::REAL_TYPE,
      Gmat::REAL_TYPE,
      Gmat::REAL_TYPE,
   ...
   phaseCenterLocation3 (0.0)
{
   ...
   for (Integer i = ImagerParamCount; i < AntennaParamCount; ++i)
