...
public:
   ...
   Real GetTDRSTransmitFrequency(std::vector<RampTableData>* rampTB);
...
protected:
   ...
   virtual bool   SignalFrequencyCalculation(std::vector<RampTableData>* rampTB, Real uplinkFrequency = 0.0, GmatTime measTime = 0.0);
