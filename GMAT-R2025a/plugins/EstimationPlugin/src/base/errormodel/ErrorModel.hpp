...
protected:
   /// Measurement type 
   std::string   measurementType;               // Accepted values: "Range", "SN_Range", "BRTS_Range", "DSN_PNRange", "DSN_SeqRange", "RangeRate", "DSN_TCP", "SN_Doppler", "SN_Doppler_Rtn", "BRTS_Doppler", "SN_DOWD", etc
   ///// Measurement trip
