...
//------------------------------------------------------------------------------
// StringArray GetOverriddenTypes()
//------------------------------------------------------------------------------
/**
 * Method used to identify class overrides for the Factory subsystem
 *
 * @return The list of class overrides from this factory
 */
//------------------------------------------------------------------------------
StringArray Factory::GetOverriddenTypes()
{
   return overrides;
}
