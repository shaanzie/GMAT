   ...
   Real pos[3], Real& mukm)
{
   ...
   //BodyFixed coordinate should use the correct gravity frame and not a user defined frame
   fixedCS->SetForGravityUpdate(true);
   ...
   //BodyFixed coordinate should use the correct gravity frame and not a user defined frame
   fixedCS->SetForGravityUpdate(false);
