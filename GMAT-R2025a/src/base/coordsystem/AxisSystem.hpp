...
protected:
   ...
   /// Used to transform Fk5 (MJ2000Eq) to ICRF 
   ICRFFile* icrfFile;
   /// Used to transform Fk5 (MJ2000Eq) to ICRF
   Rmatrix33 icrfToFK5;
   
   A1Mjd lastIcrfToFk5Epoch = 0.0;
   ...
   void CalculateSpiceFrameRotationMatrix(const std::string spiceToFrame, const GmatTime &atEpoch);
};
